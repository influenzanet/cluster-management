...
kubectl delete secrets jwt-collection case-mongodb-atlas recaptcha-collection --namespace=case
kubectl delete configmaps email-server-config --namespace=case
