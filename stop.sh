...
kubectl delete secrets jwt-collection case-mongodb-atlas recaptcha-collection --namespace=italy
kubectl delete configmaps email-server-config --namespace=italy
