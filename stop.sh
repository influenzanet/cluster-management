...
kubectl delete secrets jwt-collection case-mongodb-atlas recaptcha-collection --namespace=belgium
kubectl delete configmaps email-server-config --namespace=belgium
